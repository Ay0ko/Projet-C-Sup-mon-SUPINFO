...
void initializeSupemons() {
    ...
    Patrat = (struct Supemon) {"PATRAT", 4, 1, 3500, 100, 1, 8, 1, 1, 1, 1, 2, 2, 1, 1, 2, {Pound, Scratch}};
    Eevee = (struct Supemon) {"EEVEE", 5, 1, 4500, 110, 1, 10, 1, 1, 2, 2, 2, 2, 1, 1, 1, {Scratch, Grawl}};
    Grimer = (struct Supemon) {"GRIMER", 6, 2, 5500, 150, 1, 11, 2, 2, 1, 1, 1, 1, 2, 2, 1, {Pound, Shell}};
    Abra = (struct Supemon) {"ABRA", 7, 2, 6500, 170, 11, 1, 1, 1, 1, 1, 2, 2, 2, 2, 0, {Foliage, Grawl}};
    Turtwig = (struct Supemon) {"TURTWIG", 8, 3, 7500, 190, 1, 12, 3, 3, 2, 2, 1, 1, 2, 2, 2, {Scratch, Foliage}};
    Glaceon = (struct Supemon) {"GLACEON", 9, 3, 8500, 200, 1, 12, 2, 2, 1, 1, 2, 2, 1, 1, 3, {Pound, Shell}};
